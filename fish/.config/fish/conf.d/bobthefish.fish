# https://github.com/oh-my-fish/theme-bobthefish?tab=readme-ov-file#configuration
...
# Defined in /home/mfandrad/.local/share/omf/themes/bobthefish/functions/fish_prompt.fish @ line 1134
function __bobthefish_prompt_git --description 'Display the actual git state' --no-scope-shadowing --argument git_root_dir real_pwd
    set -l dirty ''
